...
T interpolate_value(const Vector2s& point, const Array2<T, Array1<T> >& grid) {
    int i, j;
    S fx, fy;
...
template<class T>
Vector2s affine_interpolate_value(const Vector2s& point, const Array2<T, Array1<T> >& grid) {
    int i, j;
    T fx, fy;
...
template<class S, class T>
T interpolate_gradient(Vector2s& gradient, Vector2s& point, const Array2<T, Array1<T> >& grid) {
    int i, j;
    S fx, fy;
    get_barycentric(point[0], i, fx, 0, grid.ni);
    get_barycentric(point[1], j, fy, 0, grid.nj);
