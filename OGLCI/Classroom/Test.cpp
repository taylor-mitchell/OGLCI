...
TEST_CASE("MATRIX_CPU_MULTIPLY_RECT", "[matrix]")
{
    ...
    std::vector<std::vector<float>> leftData =
    {
        { 1.0f,  2.0f,  3.0f},
        { 5.0f,  6.0f,  7.0f},
        { 9.0f, 10.0f, 11.0f},
    ...
    std::vector<std::vector<float>> rightData =
    {
        { 3.0f,  2.0f,  1.0f,  4.0f},
        { 7.0f,  6.0f,  5.0f,  8.0f},
        {11.0f, 10.0f,  9.0f, 12.0f}
    ...
    std::vector<std::vector<float>> solutionData =
    {
    ...
    Array2D<float> leftMatrix = leftData;
    Array2D<float> rightMatrix = rightData;
    Array2D<float> solutionMatrix = solutionData;
    Array2D<float> resultMatrix;
...
TEST_CASE("MATRIX_CPU_CF_MULTIPLY_SQUARE", "[matrix]")
{
    ...
    Matrix::cfMultiply(leftMatrix, rightMatrix, 4 * sizeof(float), resultMatrix);
